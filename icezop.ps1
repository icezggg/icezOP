...
try {
    ...
    [System.Windows.Forms.MessageBox]::Show("No se pudieron descargar los catálogos desde GitHub. Asegúrate de cambiar TU_USUARIO en el código.", "Error de Conexión", 0, 16)
    Exit
}
 ...
 $TableLayout.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Absolute, 70))) | Out-Null
 ...
 $LblHeader.Location = New-Object System.Drawing.Point(0, 15)
 $LblHeader.AutoSize = $true
 $PanelHeader.Controls.Add($LblHeader)

 $txtSearch = New-Object System.Windows.Forms.TextBox
 $txtSearch.Location = New-Object System.Drawing.Point(0, 45)
 ...
 $btnRec.Location = New-Object System.Drawing.Point(260, 45)
 $btnRec.Size = New-Object System.Drawing.Size(160, 30)
...
Write-Log "icezOP iniciado. Conectado a GitHub para sincronización." "LightGray"
