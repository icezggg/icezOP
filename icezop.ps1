...
public class GradientButton : Button {
    ...
    public GradientButton() { this.Color1 = Color.FromArgb(139, 92, 246); this.Color2 = Color.FromArgb(165, 120, 255); this.CornerRadius = 8; this.FlatStyle = FlatStyle.Flat; this.FlatAppearance.BorderSize = 0; }
    protected override void OnPaint(PaintEventArgs e) {
        Graphics g = e.Graphics; g.SmoothingMode = SmoothingMode.AntiAlias;
        Rectangle shadowRect = new Rectangle(0, 4, this.Width - 1, this.Height - 3);
        using (GraphicsPath shadowPath = new GraphicsPath()) {
            shadowPath.AddArc(shadowRect.X, shadowRect.Y, CornerRadius, CornerRadius, 180, 90); shadowPath.AddArc(shadowRect.Right - CornerRadius, shadowRect.Y, CornerRadius, CornerRadius, 270, 90);
            shadowPath.AddArc(shadowRect.Right - CornerRadius, shadowRect.Bottom - CornerRadius, CornerRadius, CornerRadius, 0, 90); shadowPath.AddArc(shadowRect.X, shadowRect.Bottom - CornerRadius, CornerRadius, CornerRadius, 90, 90); shadowPath.CloseFigure();
...
public class CategoryCard : Panel {
    public Label Header { get; set; } public FlowLayoutPanel Inner { get; set; } public bool IsExpanded { get; set; }
    public CategoryCard() {
        this.BackColor = Color.FromArgb(30, 30, 36); this.Size = new Size(350, 45); this.Margin = new Padding(0, 0, 15, 15); this.Cursor = Cursors.Hand;
...
public class CircularProgress : Control {
    public Color ProgressColor { get; set; } private Timer timer; private float angle = 0;
    public CircularProgress() { this.ProgressColor = Color.FromArgb(139, 92, 246); this.DoubleBuffered = true; this.Size = new Size(60, 60); timer = new Timer(); timer.Interval = 20; timer.Tick += (s, e) => { angle = (angle + 5) % 360; this.Invalidate(); }; timer.Start(); }
    protected override void OnPaint(PaintEventArgs e) { Graphics g = e.Graphics; g.SmoothingMode = SmoothingMode.AntiAlias; g.Clear(this.BackColor); using (Pen p = new Pen(ProgressColor, 4)) { p.StartCap = LineCap.Round; p.EndCap = LineCap.Round; Rectangle rect = new Rectangle(2, 2, this.Width - 6, this.Height - 6); g.DrawArc(p, rect, angle, 120); } }
}
...
public class NavButton : Button {
    ...
    protected override void OnPaint(PaintEventArgs e) {
        ...
        using (Pen p = new Pen(iconColor, 2)) {
            ...
            else if (IconType == 4) { g.DrawEllipse(p, iconX+4, iconY, 10, 10); g.DrawLine(p, iconX+9, iconY-2, iconX+9, iconY); g.DrawLine(p, iconX+9, iconY+10, iconX+9, iconY+12); g.DrawLine(p, iconX+1, iconY+5, iconX+4, iconY+5); g.DrawLine(p, iconX+14, iconY+5, iconX+17, iconY+5); } // Gear
        }
...
# --- MOTOR ASÍNCRONO Y PROGRESO ---
 ...
 $UITimer.Add_Tick({
    ...
    if ($script:sync.IsScanning -eq $false -and $script:PanelLoading.Visible -eq $true) { $script:PanelLoading.Visible = $false; $script:DriverListPanel.Visible = $true; $script:PanelDriverFooter.Visible = $true; $script:btnScanDrivers.Visible = $false }
})
...
# 1. SIDEBAR
 ...
 $LblLogo = New-Object System.Windows.Forms.Label; $LblLogo.Text = "icezOP"; $LblLogo.Font = New-Object System.Drawing.Font("Segoe Script", 18, [System.Drawing.FontStyle]::Bold); $LblLogo.ForeColor = $C_Accent; $LblLogo.Location = New-Object System.Drawing.Point(50, 8); $LblLogo.AutoSize = $true; $TitleBar.Controls.Add($LblLogo)
 ...
 $btnSettings = New-Object NavButton; $btnSettings.Text = "Configuración"; $btnSettings.IconType = 4; $btnSettings.Location = New-Object System.Drawing.Point(0, 680); $btnSettings.Size = New-Object System.Drawing.Size(220, 40); $btnSettings.BackColor = $C_BgLayer; $btnSettings.ForeColor = $C_TextSec; $btnSettings.Font = $FontGlobal; $btnSettings.Cursor = "Hand"; $Sidebar.Controls.Add($btnSettings)
...
# PANEL DRIVERS
 ...
 $btnUpdateSelected = New-Object GradientButton; $btnUpdateSelected.Text = "Actualizar Seleccionados"; $btnUpdateSelected.Location = New-Object System.Drawing.Point(400, 10); $btnUpdateSelected.Size = New-Object System.Drawing.Size(180, 40); $btnUpdateSelected.Color1 = [System.Drawing.Color]::FromArgb(60, 60, 70); $btnUpdateSelected.Color2 = [System.Drawing.Color]::FromArgb(80, 80, 90); $btnUpdateSelected.ForeColor = [System.Drawing.Color]::White; $btnUpdateSelected.Font = $FontGlobal; $btnUpdateSelected.Cursor = "Hand"; $btnUpdateSelected.CornerRadius = 8; $btnUpdateSelected.Visible = $false; $PanelDriverFooter.Controls.Add($btnUpdateSelected)
 $btnUpdateAll = New-Object GradientButton; $btnUpdateAll.Text = "Actualizar Todos"; $btnUpdateAll.Location = New-Object System.Drawing.Point(600, 10); $btnUpdateAll.Size = New-Object System.Drawing.Size(180, 40); $btnUpdateAll.Color1 = [System.Drawing.Color]::FromArgb(139, 92, 246); $btnUpdateAll.Color2 = [System.Drawing.Color]::FromArgb(165, 120, 255); $btnUpdateAll.ForeColor = [System.Drawing.Color]::White; $btnUpdateAll.Font = $FontGlobal; $btnUpdateAll.Cursor = "Hand"; $btnUpdateAll.CornerRadius = 8; $PanelDriverFooter.Controls.Add($btnUpdateAll)
...
# FOOTER GLOBAL
 ...
 $AppsJson = @"
[ { "Name": "Google Chrome", "ID": "Google.Chrome", "Cat": "Navegadores", "Rec": true }, { "Name": "Mozilla Firefox", "ID": "Mozilla.Firefox", "Cat": "Navegadores", "Rec": true }, { "Name": "Brave", "ID": "Brave.Brave", "Cat": "Navegadores", "Rec": false }, { "Name": "Opera GX", "ID": "Opera.OperaGX", "Cat": "Navegadores", "Rec": false }, { "Name": "Discord", "ID": "Discord.Discord", "Cat": "Comunicacion", "Rec": true }, { "Name": "WhatsApp", "ID": "WhatsApp.WhatsApp", "Cat": "Comunicacion", "Rec": true }, { "Name": "Telegram", "ID": "Telegram.TelegramDesktop", "Cat": "Comunicacion", "Rec": false }, { "Name": "Visual Studio Code", "ID": "Microsoft.VisualStudioCode", "Cat": "Programacion", "Rec": true }, { "Name": "Git", "ID": "Git.Git", "Cat": "Programacion", "Rec": true }, { "Name": "Windows Terminal", "ID": "Microsoft.WindowsTerminal", "Cat": "Programacion", "Rec": true }, { "Name": "Steam", "ID": "Valve.Steam", "Cat": "Juegos", "Rec": true }, { "Name": "Epic Games Launcher", "ID": "EpicGames.EpicGamesLauncher", "Cat": "Juegos", "Rec": false }, { "Name": "VLC Media Player", "ID": "VideoLAN.VLC", "Cat": "Video", "Rec": true }, { "Name": "OBS Studio", "ID": "OBSProject.OBSStudio", "Cat": "Video", "Rec": true }, { "Name": "Spotify", "ID": "Spotify.Spotify", "Cat": "Audio", "Rec": true }, { "Name": "7-Zip", "ID": "7zip.7zip", "Cat": "Utilidades", "Rec": true }, { "Name": "Everything", "ID": "voidtools.Everything", "Cat": "Utilidades", "Rec": true }, { "Name": "Microsoft PowerToys", "ID": "Microsoft.PowerToys", "Cat": "Utilidades", "Rec": true }, { "Name": "Bitwarden", "ID": "Bitwarden.Bitwarden", "Cat": "Seguridad", "Rec": true }, { "Name": "qBittorrent", "ID": "qBittorrent.qBittorrent", "Cat": "Downloads", "Rec": true } ]
"@
 $TweaksJson = @"
[ { "Cat": "Privacidad", "Name": "Desactivar Telemetría", "Script": "Set-ItemProperty 'HKLM:\\SOFTWARE\\Policies\\Microsoft\\Windows\\DataCollection' -Name 'AllowTelemetry' -Value 0 -Type DWord -Force" }, { "Cat": "Privacidad", "Name": "Desactivar Advertising ID", "Script": "Set-ItemProperty 'HKCU:\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\AdvertisingInfo' -Name 'Enabled' -Value 0 -Type DWord -Force" }, { "Cat": "Interfaz", "Name": "Mostrar Extensiones", "Script": "Set-ItemProperty 'HKCU:\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Advanced' -Name 'HideFileExt' -Value 0 -Type DWord -Force" }, { "Cat": "Interfaz", "Name": "Menú Clásico Win10", "Script": "Set-ItemProperty 'HKCU:\\Software\\Classes\\CLSID\\{86ca1aa0-34aa-4e8b-a509-50c905bae2a2}\\InprocServer32' -Name '(Default)' -Value '' -Type String -Force" }, { "Cat": "Rendimiento", "Name": "Desactivar Hibernación", "Script": "powercfg -h off" }, { "Cat": "Rendimiento", "Name": "Plan Ultimate", "Script": "powercfg -duplicatescheme e9a42b02-d5df-448d-aa00-03f14749eb61 | Out-Null" }, { "Cat": "Gaming", "Name": "Desactivar Game DVR", "Script": "Set-ItemProperty 'HKCU:\\System\\GameConfigStore' -Name 'GameDVR_Enabled' -Value 0 -Type DWord -Force" }, { "Cat": "Red", "Name": "Limpiar DNS", "Script": "ipconfig /flushdns" } ]
"@
...
# --- LÓGICA DE MÓDULOS Y CIERRE DE ÁMBITO (FIX) ---
...
function Set-AppModule {
    ...
    $LblHeader.Text = "Aplicaciones"; $LblHeader.Location = New-Object System.Drawing.Point(0, 35); Clear-DynamicPanel; $txtSearch.Text = "Buscar..."; $txtSearch.ForeColor = $C_TextSec
    ...
    foreach ($cat in $Categories) {
        ...
        foreach ($app in $appsInCat) {
            ...
            # FIX DE ÁMBITO: GetNewClosure() captura el valor actual de $Card y $cat
            $cb.Add_CheckedChanged({
                $checked = 0; foreach($c in $Card.Inner.Controls) { if($c.Checked) { $checked++ } }
...
function Set-TweaksModule {
    ...
    $LblHeader.Text = "Tweaks"; $LblHeader.Location = New-Object System.Drawing.Point(0, 35); Clear-DynamicPanel
...
function Set-DriversModule { Set-ModuleActive $btnModDrivers; $script:CurrentModule = "Drivers"; $DynPanel.Visible = $false; $PanelDrivers.Visible = $true; $PanelSearch.Visible = $false; $btnExecute.Visible = $false; $LblHeader.Text = "Gestor de Drivers"; $LblHeader.Location = New-Object System.Drawing.Point(260, 0) }
...
# --- ANIMACIÓN DEL MENÚ LATERAL (EASING) ---
 ...
 $AnimTimer.Add_Tick({
    ...
    $RootLayout.ColumnStyles[0].Width = $AnimState.Current
    if ($AnimState.Current -lt 100) { $LblLogo.Visible = $false } else { $LblLogo.Visible = $true }
})
...
# --- ESCANEO REAL DE DRIVERS (CON RETARDO PARA FEEDBACK VISUAL) ---
 $btnScanDrivers.Add_Click({
    $sync.IsScanning = $true; $btnScanDrivers.Visible = $false; $PanelLoading.Visible = $true; $DriverListPanel.Visible = $false; $PanelDriverFooter.Visible = $false; $sync.DriverQueue.Enqueue(@{ Clear = $true })
    $job = {
        param($syncHash)
        try { Start-Sleep -Seconds 3 # Retardo intencional para mostrar el Progress Ring
            $pnpDrivers = Get-CimInstance Win32_PnPSignedDriver -ErrorAction Stop | Where-Object { $_.DeviceName } | Select-Object -First 10
            foreach($drv in $pnpDrivers) {
                $isOld = $false; if ($drv.DriverDate) { $age = (Get-Date) - $drv.DriverDate; if ($age.Days -gt 730) { $isOld = $true } }
                $cat = if ($isOld) { "Pending" } else { "Updated" }; $status = if ($isOld) { "[Antiguo]" } else { "[OK]" }; $color = if ($isOld) { [System.Drawing.Color]::FromArgb(250, 204, 21) } else { [System.Drawing.Color]::FromArgb(100, 100, 100) }
            ...
            if ($vcApps) { foreach($app in $vcApps) { $syncHash.DriverQueue.Enqueue(@{ Cat="Pending"; Name="$($app.DisplayName) (v$($app.DisplayVersion))"; Status="[Librería]"; Color=[System.Drawing.Color]::FromArgb(139, 92, 246) }) } }
        } catch { $syncHash.DriverQueue.Enqueue(@{ Cat="Pending"; Name="Error de escaneo"; Status="[ERR]"; Color=[System.Drawing.Color]::FromArgb(239, 68, 68) }) }
...
# --- LÓGICA BOTÓN ACTUALIZAR SELECCIONADOS (DINÁMICO) ---
 $DriverListPanel.ControlAdded({ foreach($ctrl in $DriverListPanel.Controls) { if($ctrl.Check) { $ctrl.Check.Add_CheckedChanged({ $anyChecked = $false; foreach($c in $DriverListPanel.Controls) { if($c.Check -and $c.Check.Checked) { $anyChecked = $true; break } }; $btnUpdateSelected.Visible = $anyChecked }) } } })
 ...
 $btnExecute.Add_Click({
    ...
    $job = {
        ...
        foreach ($item in $items) {
            ...
            if ($mod -eq "Apps") { $syncHash.LogQueue.Enqueue(@{ Text="Instalando $name..."; Color="Cyan" }); try { $proc = Start-Process winget -ArgumentList "install --id $tag -e --accept-package-agreements --accept-source-agreements -h" -Wait -PassThru -NoNewWindow; if ($proc.ExitCode -eq 0) { $syncHash.LogQueue.Enqueue(@{ Text="$name instalado."; Color="MediumPurple" }) } else { $syncHash.LogQueue.Enqueue(@{ Text="Error en $name."; Color="Red" }) } } catch { $syncHash.LogQueue.Enqueue(@{ Text="Excepción: $name."; Color="Red" }) } }
            elseif ($mod -eq "Tweaks") { $syncHash.LogQueue.Enqueue(@{ Text="Aplicando: $name"; Color="Cyan" }); try { $sb = [ScriptBlock]::Create($tag.ToString()); & $sb; $syncHash.LogQueue.Enqueue(@{ Text="OK: $name"; Color="MediumPurple" }) } catch { $syncHash.LogQueue.Enqueue(@{ Text="Error: $name"; Color="Red" }) } }
 ...
 $UITimer.Start(); Set-AppModule; $Form.ShowDialog() | Out-Null
